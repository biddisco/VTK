...
int TestSmartVolumeMapperScalarLinearGradientLinear(int argc,
                          char *argv[])
{
  ...
  vtkPiecewiseFunction *scalarLinearOpacity = vtkPiecewiseFunction::New();
  scalarLinearOpacity->AddPoint(0.0,0.0);
  scalarLinearOpacity->AddPoint(40.0,1.0);
  scalarLinearOpacity->AddPoint(80.1,0.0);
  scalarLinearOpacity->AddPoint(255.0,0.0);
  volumeProperty->SetScalarOpacity(scalarLinearOpacity); // scalarLinear first.



  vtkPiecewiseFunction *gradientLinearOpacity = vtkPiecewiseFunction::New();
    gradientLinearOpacity->AddPoint(0.0,1.0);
    gradientLinearOpacity->AddPoint(2.0,1.0);
    gradientLinearOpacity->AddPoint(2.1,0.0);
    gradientLinearOpacity->AddPoint(80.0,1.0);
    volumeProperty->SetGradientLinearOpacity(gradientLinearOpacity); // composite first.
    volumeProperty->SwitchGradientOpacity(false);
    volumeProperty->SetDisableGradientLinearOpacity(false);
  ...
  iren->Delete();
  t->Delete();
  scalarLinearOpacity->Delete();
  gradientLinearOpacity->Delete();
