                                             ...
                                             vtkVolume *vol)
{
  ...
  for ( k = 0; k < numSteps; k++ )
    ...
    VTKKWRCHelper_LookupColorSCGOUS( colorTable[0], twoDOpacityTable[0], val, mag, tmp );
                                                     ...
                                                     vtkVolume *vol)
{
  ...
  for ( k = 0; k < numSteps; k++ )
    ...
    VTKKWRCHelper_LookupAndCombineIndependentColorsSCGOShadeUS( colorTable, twoDOpacityTable,
                                                              diffuseShadingTable,
...
// the ray.
template <class T>
void vtkFixedPointCompositeSCGOShadeHelperGenerateImageTwoDependentTrilin( T *data,
                                                          int threadID,
                                                          int threadCount,
                                                          vtkFixedPointVolumeRayCastMapper *mapper,
                                                          vtkVolume *vol)
...
template <class T>
void vtkFixedPointCompositeSCGOShadeHelperGenerateImageFourDependentTrilin( T *data,
                                                           int threadID,
                                                           int threadCount,
                                                           vtkFixedPointVolumeRayCastMapper *mapper,
                                                           vtkVolume *vol)
...
// move on to the next sample along the ray.
template <class T>
void vtkFixedPointCompositeSCGOShadeHelperGenerateImageIndependentTrilin( T *data,
                                                         int threadID,
                                                         int threadCount,
                                                         vtkFixedPointVolumeRayCastMapper *mapper,
                                                         vtkVolume *vol)
...
void vtkFixedPointVolumeRayCastCompositeSCGOShadeHelper::GenerateImage( int threadID,
                                                 int threadCount,
                                                 vtkVolume *vol,
                                                 vtkFixedPointVolumeRayCastMapper *mapper )
{
...
void vtkFixedPointVolumeRayCastCompositeSCGOShadeHelper::PrintSelf(ostream& os, vtkIndent indent)
{
