...
{
public:
  static vtkFixedPointVolumeRayCastCompositeSCGOShadeHelper *New();
  vtkTypeMacro(vtkFixedPointVolumeRayCastCompositeSCGOShadeHelper,vtkFixedPointVolumeRayCastHelper);
...
private:
  vtkFixedPointVolumeRayCastCompositeSCGOShadeHelper(const vtkFixedPointVolumeRayCastCompositeSCGOShadeHelper&);  // Not implemented.
