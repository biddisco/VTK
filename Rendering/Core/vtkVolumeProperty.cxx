...
void vtkVolumeProperty::DeepCopy(vtkVolumeProperty *p)
  ...
  for (int i = 0; i < VTK_MAX_VRCOMP; i++)
    ...
    this->SetDisableGradientLinearOpacity(i,
        p->GetDisableGradientLinearOpacity(i));
...
void vtkVolumeProperty::CreateDefaultGradientGaussianOpacity(int index)
  ...
  if (this->DefaultGradientGaussianOpacity[index] == NULL)
    {
    this->DefaultGradientGaussianOpacity[index] =
...
vtkGaussianPiecewiseFunction *vtkVolumeProperty::GetGradientGaussianOpacity(
    int index)
  {
...
vtkPiecewiseFunction *vtkVolumeProperty::GetStoredGradientLinearOpacity(
    int index)
  {
  if (this->GradientLinearOpacity[index] == NULL)
    {
