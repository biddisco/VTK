/*=========================================================================
  ...
  Module                  : vtkSerialBoundsExtentTranslator.h
...
=========================================================================*/
//
// .NAME vtkSerialBoundsExtentTranslator - Extent translation using bounding boxes of data partitions
// .SECTION Description
// vtkSerialBoundsExtentTranslator provides a vtkExtentTranslator that is
...
#ifndef __vtkSerialBoundsExtentTranslator_h
#define __vtkSerialBoundsExtentTranslator_h
...
class VTKCOMMONEXECUTIONMODEL_EXPORT vtkSerialBoundsExtentTranslator : public vtkExtentTranslator
{
public:
  vtkTypeMacro(vtkSerialBoundsExtentTranslator,vtkExtentTranslator);
  
  static vtkInformationObjectMetaDataKey* META_DATA();
  static vtkSerialBoundsExtentTranslator* New();

  virtual void ShallowCopy(vtkSerialBoundsExtentTranslator *trans);
...
protected:
   vtkSerialBoundsExtentTranslator();
  ~vtkSerialBoundsExtentTranslator();
...
private:
  vtkSerialBoundsExtentTranslator(const vtkSerialBoundsExtentTranslator&);  // Not implemented.
  void operator=(const vtkSerialBoundsExtentTranslator&);  // Not implemented.
};
